...
For PHP scripts, you should prefer create your own module with scripts triggered at module init and using the DOLI_ENABLE_MODULES instead of doing that.
```
\docker-init.d
|- custom_script.sql
|- custom_script.php
